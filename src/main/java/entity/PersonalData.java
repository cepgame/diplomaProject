...
{
    public PersonalData(String rawLine) {
        String[] splitedLine = rawLine.split(",");

        id = Integer.valueOf(splitedLine[0]);
        age = Double.valueOf(splitedLine[1]);
        gender = Double.valueOf(splitedLine[2]);
        education = Double.valueOf(splitedLine[3]);
        country = Double.valueOf(splitedLine[4]);
        ethnicity = Double.valueOf(splitedLine[5]);
        nscore = Double.valueOf(splitedLine[6]);
        escore = Double.valueOf(splitedLine[7]);
        oscore = Double.valueOf(splitedLine[8]);
        ascore = Double.valueOf(splitedLine[9]);
        cscore = Double.valueOf(splitedLine[10]);
        impulsive = Double.valueOf(splitedLine[11]);
        sensationSeeing = Double.valueOf(splitedLine[12]);
        alcohol = splitedLine[13];
        amphetamin = splitedLine[14];
        amyl = splitedLine[15];
        benzodiazepine = splitedLine[16];
        caffein = splitedLine[17];
        canabis = splitedLine[18];
        chocolate = splitedLine[19];
        cocain = splitedLine[20];
        crack = splitedLine[21];
        ecstasy = splitedLine[22];
        heroin = splitedLine[23];
        ketamin = splitedLine[24];
        legalHighs = splitedLine[25];
        lsd = splitedLine[26];
        methadone = splitedLine[27];
        mushrooms = splitedLine[28];
        nicotine = splitedLine[29];
        semer = splitedLine[30];
        vsa = splitedLine[31];
    }
    ...
    /**
     escore (Real) is NEO-FFI-R Extraversion. Possible values are presented in table below:
    ...
    /**
     oscore (Real) is NEO-FFI-R Openness to experience. Possible values are presented in table below:
    ...
    /**
     ascore (Real) is NEO-FFI-R Agreeableness. Possible values are presented in table below:
    ...
    /**
     cscore (Real) is NEO-FFI-R Conscientiousness. Possible values are presented in table below:
    ...
    /**
     Impulsive (Real) is impulsiveness measured by BIS-11. Possible values are presented in table below:
    ...
    /**
     SS (Real) is sensation seeing measured by ImpSS. Possible values are presented in table below:
     SS Cases Fraction
     -2.07848 71 3.77%
     -1.54858 87 4.62%
     -1.18084 132 7.00%
     ...
     */
    @Column(name = "amphetamin")
    String amphetamin;

    /**
     Amyl is class of amyl nitrite consumption. It is output attribute with following distribution of classes.
     */
    @Column(name = "amyl")
    String amyl;
    ...
    /**
     ...
     Value  Class                  Alcohol         Amphetamin       Amyl nitrit   Benzodiazepine
     Case Fraction  Case Fraction  Case  Fraction  Case   Fraction
     ...
     */
    @Column(name = "benzodiazepine")
    String benzodiazepine;

    /**
     Caff is class of caffeine consumption. It is output attribute with following distribution of classes.
     */
    @Column(name = "caffein")
    String caffein;

    /**
     Cannabis is class of cannabis consumption. It is output attribute with following distribution of classes.4
     */
    @Column(name = "canabis")
    String canabis;

    /**
     Choc is class of chocolate consumption. It is output attribute with following distribution of classes.
     */
    @Column(name = "chocolate")
    String chocolate;

    /**
     Coke is class of cocaine consumption. It is output attribute with following distribution of classes:
    ...
    /**
     Crack is class of crack consumption. It is output attribute with following distribution of classes.
     */
    @Column(name = "crack")
    String crack;

    /**
     Ecstasy is class of ecstasy consumption. It is output attribute with following distribution of classes.
     */
    @Column(name = "ecstasy")
    String ecstasy;

    /**
     Heroin is class of heroin consumption. It is output attribute with following distribution of classes.
     */
    @Column(name = "heroin")
    String heroin;

    /**
     Ketamine is class of ketamine consumption. It is output attribute with following distribution of classes:
    ...
    /**
     Legalh is class of legal highs consumption. It is output attribute with following distribution of classes
     */
    @Column(name = "legal_highs")
    String legalHighs;

    /**
     LSD is class of alcohol consumption. It is output attribute with following distribution of classes
     */
    @Column(name = "lsd")
    String lsd;

    /**
     Meth is class of methadone consumption. It is output attribute with following distribution of classes.
     */
    @Column(name = "methadone")
    String methadone;

    /**
     Mushrooms is class of magic mushrooms consumption. It is output attribute with following distribution of classes:
    ...
    /**
     Nicotine is class of nicotine consumption. It is output attribute with following distribution of classes.
     */
    @Column(name = "nicotine")
    String nicotine;

    /**
     Semer is class of fictitious drug Semeron consumption. It is output attribute with following distribution of classes.
     */
    @Column(name = "semer")
    String semer;

    /**
     VSA is class of volatile substance abuse consumption. It is output attribute with following distribution of classes:
    ...
    public void setOscore(double oscore) {
        this.oscore = oscore;
    }
    ...
    public double getSensationSeeing() {
        return sensationSeeing;
    }

    public void setSensationSeeing(double sensationSeeing) {
        this.sensationSeeing = sensationSeeing;
    }
    ...
    public String getAmphetamin() {
        return amphetamin;
    }

    public void setAmphetamin(String amphetamin) {
        this.amphetamin = amphetamin;
    }
    ...
    public void setAmyl(String amyl) {
        this.amyl = amyl;
    }
    ...
    public String getCanabis() {
        return canabis;
    }

    public void setCanabis(String canabis) {
        this.canabis = canabis;
    }
    ...
    public void setEcstasy(String ecstasy) {
    ...
    public void setKetamin(String ketamin) {
        this.ketamin = ketamin;
    }

    public String getLegalHighs() {
        return legalHighs;
    }

    public void setLegalHighs(String legalHighs) {
        this.legalHighs = legalHighs;
    }
    ...
    public void setSemer(String semer) {
        this.semer = semer;
    }
    ...
    public String toString() {
        return "PersonalData{" +
                ...
                ", cscore=" + cscore +
                ", impulsive=" + impulsive +
                ", sensationSeeing=" + sensationSeeing +
                ", alcohol='" + alcohol + '\'' +
